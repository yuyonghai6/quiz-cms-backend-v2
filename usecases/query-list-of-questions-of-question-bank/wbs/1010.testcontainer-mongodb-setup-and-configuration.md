...
spring.data.mongodb.uri=mongodb://localhost:27018/test-quizfun-query
...
spring.data.mongodb.uri=mongodb://localhost:27018/quizfun-query
spring.data.mongodb.read-preference=primary
...
- ✅ Should expose container on port 27018
 ...
 *   <li>Container port 27018 is exposed correctly</li>
...
- [ ] Container port 27018 exposed correctly
...
- **Internal Port**: 27018 (MongoDB default inside container)
- **External Port**: Random port assigned by Docker (e.g., 32768, 49153, etc.)
- **Why**: Prevents port conflicts when running multiple tests

```java
// ❌ WRONG: Don't assume port 27018 is the external port
.withExposedPorts(27018)  // This is NOT the external port

// ✅ CORRECT: Expose MongoDB's internal port 27018
.withExposedPorts(27018)  // Internal port
